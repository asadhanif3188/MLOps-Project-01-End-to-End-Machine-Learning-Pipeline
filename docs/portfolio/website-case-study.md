...
<sub>This is the full **project detail page**. For a projects grid or a featured block,
use the short-form card / summary in
[website-card.md](website-card.md), which links here.</sub>
